...
echo "All log files (and label-checking files) from research_storage Ben --> archive"
rsync $options --include="*.?og" --include="*.?nc" --include="*.md" --include="*.Labels.Check.png" --exclude="._*" --exclude="*" ~/research_storage_ben/microCT_Stickleback/ ~/research_storage_uct/Archiv_Tape/IEE\ Stickleback/
